<template>
  ...
  <script>
    ...
    export default {
      ...
      computed:{  
        ...mapGetters({
                allSupplier: 'supplier/getAllItem',
                totalSupplier: 'supplier/getTotalItem',
      ...
      methods:{     
            ...mapActions({
                fetchSupplier: 'supplier/fetchAction',
            }),         
            openForm(){
                this.dialog = true
            },
            tambahItem(){
                this.loading2 = true        
                axios({
                    url: `${this.$store.state.url}/supplier`,
                    method: 'post',
                    headers:{
            ...
            editSup(){
                this.loading2 = true        
                axios({
                    url: `${this.$store.state.url}/supplier/${this.idTemp}`,
                    method: 'put',
                    headers:{
                        token : localStorage.getItem('token')
                    },
            ...
            deleteSup(id){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios({
                        url: `${this.$store.state.url}/supplier/${id}`,
                        method: 'delete',
                        headers:{
                            token : localStorage.getItem('token')
                        }
